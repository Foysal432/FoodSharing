const Footer = () => {
    return(
        <footer className="footer footer-center p-10 bg-green-200">
        <aside>
          ...
          <p className="font-bold">
            footer donate Industries Ltd. <br/>Providing reliable food since 1992
          </p> 
          <p>Copyright © 2023 Donation Food - All right reserved</p>
        </aside> 
        <nav>
