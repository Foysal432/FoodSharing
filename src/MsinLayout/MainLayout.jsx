...
const MainLayout = ({children}) => {
  ...
  const handlelogout =()=>{
    ...
    <li><a><NavLink to='about' className={({isActive})=>isActive? "btn btn-outline btn-accent font-serif":"btn btn-ghost font-serif"}>Available Foods</NavLink></a></li>
    <li><a><NavLink to='about' className={({isActive})=>isActive? "btn btn-outline btn-accent font-serif":"btn btn-ghost font-serif"}>Add Food</NavLink></a></li>
    <li><a><NavLink to='about' className={({isActive})=>isActive? "btn btn-outline btn-accent font-sans":"btn btn-ghost font-serif"}>Manage My Foods</NavLink></a></li>
    <li><a><NavLink to='about' className={({isActive})=>isActive? "btn btn-outline btn-accent font-serif":"btn btn-ghost font-serif"}>My Food Request</NavLink></a></li>
