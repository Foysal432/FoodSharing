...
// const navigate =useNavigate()
  ...
  return (
    <div className="md:flex max-w-4xl mx-auto justify-around mt-10">
      <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border  text-gray-700 shadow-none">
        <h4 className="block font-sans text-green-500 text-2xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased">
          Register From Here
        </h4>
        ...
        <form onSubmit={handleRegister} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
          ...
          <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
            ...
            <a>
              <Link to='/login' className="font-medium text-green-500 transition-colors hover:text-blue-700">Log In</Link>
            </a>
          </p>
        </form>
      </div>
      <div className="w-1/2">
        <img src="https://i.ibb.co/Dgpg3WR/4934425.jpg" alt="" />
      </div>
    </div>
  )
}
