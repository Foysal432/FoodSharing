const AddFood = () => {
    return(
        <div>
         <div className="relative flex bg-green-100 flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
  ...
  <form className="mt-8 mb-2 max-w-7xl mx-auto">
