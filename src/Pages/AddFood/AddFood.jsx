...
const foodquantity =Number(form.quantity.value);
const pickuplocation =form.location.value;
const expiredtime =(form.date.value);
const foodstatus =form.status.value;
const additionalnotes =form.additional.value;
...
console.log(user);
  ...
  .then(data=>{
    ...
    return(
        <div>
         <div className="relative flex bg-green-200 flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
  <h4 className="block text-center my-5  font-sans text-2xl font-bold leading-snug tracking-normal text-green-600 antialiased">
   Add Your Food
  </h4>
  ...
  <select
  name="status"
  className="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 empty:!bg-red-500 focus:border-2 focus:border-green-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50">
  ...
  <div className="relative w-full min-w-[200px]">
    ...
    <button
      className="mt-3 block w-full select-none rounded-lg bg-green-500 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-green-500/20 transition-all hover:shadow-lg hover:shadow-green-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
      type="submit"
